...
public class UseAsTestName_TestBase implements ITest
{
    ...
    /**
     * Allows us to set the current test name internally to this class so that the TestNG framework can use the {@link ITest}
     * implementation for naming tests.
     */
    ...
    /**
     * Method to transform the name of tests when they are called with the testname as one of the parameters. Only takes effect if method
     * has {@link UseAsTestName} annotation on it..
     *
